...
@section('color', '#534A42')

@section('bg', asset("/projectbg/" . $project['nim'] . ".png"))

@section('content')

<div class="text-[#534A42] pt-[72px]">
    <div class="py-4">
        <button id="backButton" class="text-lg hebrew font-bold py-2 px-6 bg-gradient-to-r from-[#534A42] fixed top-20 left-0 z-50">< Back</button>
    </div>
    <div class="flex flex-wrap-reverse w-full md:justify-between justify-around justify-items-center place-items-center pt-8 px-12">
        <div class="text-center md:text-left w-96 md:w-2/5 pt-12 md:pt-0">
            <p class="text-2xl min-[1015px]:text-4xl min-[1300px]:text-5xl erica">{{ $project['title'] }}</p>
            <br>
    ...
    <div class="flex flex-wrap-reverse w-full justify-between justify-items-center items-end place-items-center px-12 py-16">
        <div class="w-full md:w-5/12 pt-12 md:pt-0 flex flex-col gap-x-6 items-center">
            ...
            {{-- Contact Card --}}
            <div class="text-white grid grid-cols-2 rounded-lg bg-gradient-to-b from-[#534A42] p-5 w-full gap-x-6 min-[541px]:w-3/4 md:w-full">
                <div>
