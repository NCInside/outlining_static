...
<div class="text-[#152b51] pt-[72px]">
    <div class="py-4">
        <button id="backButton" class="text-lg hebrew font-bold py-2 px-6 bg-gradient-to-r text-white from-[#000000] fixed top-20 left-0 z-50">< Back</button>
    </div>
    <div class="flex flex-wrap-reverse w-full md:justify-between justify-around justify-items-center place-items-center pt-8 px-12">
        <div class="text-center md:text-left w-96 md:w-2/5 pt-12 md:pt-0">
            <p class="text-4xl md:text-3xl min-[920px]:text-4xl min-[1300px]:text-5xl erica">{{ $project['title'] }}</p>
            <br>
    ...
    <div class="flex flex-wrap-reverse w-full justify-between justify-items-center items-end place-items-center px-12 py-16">
        <div class="w-full md:w-5/12 pt-12 md:pt-0 flex flex-col gap-x-6 items-center">
            ...
            {{-- Contact Card --}}
            <div class="grid grid-cols-2 rounded-lg bg-[#152b51] p-5 w-full gap-x-6 min-[541px]:w-3/4 md:w-full text-white">
                <div>
