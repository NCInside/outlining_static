...
<div class="text-[#ffac4e] pt-[72px]">
    ...
    <div class="flex flex-wrap-reverse w-full md:justify-between justify-around justify-items-center place-items-center pt-8 px-12">
        <div class="text-center md:text-left w-96 md:w-2/5 pt-12 md:pt-0">
            ...
            <br>
            <p class="text-lg hebrew md:text-base min-[1300px]:text-xl font-bold text-black">{{ $project['description'] }}</p>
        </div>
    ...
    <div class="flex flex-wrap-reverse w-full justify-between justify-items-center items-end place-items-center px-12 py-16">
        <div class="w-full md:w-5/12 pt-12 md:pt-0 flex flex-col gap-x-6 items-center">
            ...
            {{-- Contact Card --}}
            <div class="grid grid-cols-2 rounded-lg bg-gradient-to-b from-[#65b3b4] p-5 w-full gap-x-6 min-[541px]:w-3/4 md:w-full">
                <div>
                    <p class="min-[1198px]:text-4xl md:text-2xl min-[404px]:text-3xl text-2xl hebrew font-bold pb-1 md:pb-3 text-white">Contact: </p>
                    <p class="min-[1198px]:text-2xl md:text-lg min-[404px]:text-xl text-lg overflow-wrap break-words hebrew font-bold text-black">{{ $project['ig'] }}</p>
                    <p class="min-[1198px]:text-2xl md:text-lg min-[404px]:text-xl text-lg overflow-wrap break-words hebrew font-bold text-black">{{ $project['wa']}}</p>
                </div>
                <div>
                    <p class="min-[1198px]:text-4xl min-[404px]:text-3xl text-2xl hebrew font-bold pb-3 text-white">Scan / click here!</p>
