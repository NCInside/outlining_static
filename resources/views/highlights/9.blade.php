...
<div class="text-white">
    ...
    <div class="flex flex-wrap-reverse w-full justify-around justify-items-center place-items-center pt-8 px-12">
        <div class="text-center md:text-left w-96 md:w-2/5 pt-12 md:pt-0">
            <p class="text-4xl md:text-3xl min-[853px]:text-4xl min-[1400px]:text-5xl erica">{{ $project['title'] }}</p>
            <br>
            <p class="text-lg hebrew min-[1400px]:text-xl font-bold">{{ $project['description'] }}</p>
        </div>
    ...
    <div class="flex flex-wrap-reverse w-full justify-center justify-items-center items-end place-items-center px-6 py-16">
        <div class="w-full md:w-5/12 pt-12 md:pt-0 flex flex-col gap-x-6 items-center min-[1198px]:pl-16">
            ...
            {{-- Contact Card --}}
            <div class="grid grid-cols-2 rounded-lg bg-gradient-to-b from-[#f500fe] p-5 w-full gap-x-6 min-[541px]:w-3/4 md:w-full">
                <div>
