...
<div class="text-white pt-[72px]">
    <div class="py-4">
        <button id="backButton" class="text-lg hebrew font-bold py-2 px-6 bg-gradient-to-r from-[#ff8b1a] fixed top-20 left-0 z-50">< Back</button>
    </div>
    <div class="flex flex-wrap-reverse w-full md:justify-between justify-around justify-items-center place-items-center pt-8 px-12">
        <div class="text-center md:text-left w-96 md:w-2/5 pt-12 md:pt-0">
            <p class="text-4xl md:text-3xl min-[920px]:text-4xl min-[1300px]:text-5xl erica text-[#fa51b2]">{{ $project['title'] }}</p>
            <br>
            <p class="text-lg hebrew md:text-base min-[1300px]:text-xl font-bold text-[#ff8b1a]">{{ $project['description'] }}</p>
        </div>
    ...
    <div class='text-center grid grid-cols-1 justify-center pt-16 px-2'>
        <p class='erica text-2xl text-[#fa51b2]'>Final Project Gallery</p>
        <div class="relative">
    ...
    <div class="flex flex-wrap-reverse w-full justify-between justify-items-center items-end place-items-center px-12 py-16">
        <div class="w-full md:w-5/12 pt-12 md:pt-0 flex flex-col gap-x-6 items-center">
            <div class="w-full pb-6 md:pb-12 md:pt-12 text-center md:text-left">
                <p class="md:text-6xl sm:text-5xl text-4xl erica pb-2 md:pb-6 text-[#fa51b2]">{{ $project['name']}}</p>
                <p class="md:text-2xl sm:text-xl text-lg erica text-[#ff8b1a]">{{ $project['nim'] }}</p>
            </div>
            {{-- Contact Card --}}
            <div class="grid grid-cols-2 rounded-lg bg-gradient-to-b from-[#ff8b1a] p-5 w-full gap-x-6 min-[541px]:w-3/4 md:w-full">
                <div>
